        ...
        <div className='bg-[#0E041D] inter text-white'>
            <div className='container mx-auto flex justify-between items-center py-6 px-4 lg:px-0'>
                ...
                <ul className='hidden lg:flex items-center gap-8 font-bold'>
                    <Link href={'/'}><li className='hover:scale-105 duration-300 cursor-pointer'>Bosh sahifa</li></Link>
                    <Link href={'/portfolio-page'}><li className='hover:scale-105 duration-300 cursor-pointer'>Portfolio</li></Link>
                    <Link href={'/service-page'}><li className='hover:scale-105 duration-300 cursor-pointer'>Xizmatlar</li></Link>
            ...
            {isOpen && (
                <div className='lg:hidden px-6 pb-6'>
                    <ul className='flex flex-col gap-4 font-semibold'>
                        <Link href={'/'} onClick={() => setIsOpen(false)}><li>Bosh sahifa</li></Link>
                        <Link href={'/portfolio-page'} onClick={() => setIsOpen(false)}><li>Portfolio</li></Link>
                        <Link href={'/service-page'} onClick={() => setIsOpen(false)}><li>Xizmatlar</li></Link>
                        <li>Aloqa</li>
                    </ul>
